...
```text
luci-app-sheepfold-family-internet-control_0.1.0-276_all.ipk
```
...
- Additional `/api/v1/*` routes, a refresh-token flow, and Android editors for the remaining LuCI sections remain target work. The current authenticated routes cover pairing, devices, global internet state, router information, schedules, groups, Wi-Fi, logs, feedback, and AI where the installed product variant permits it.
