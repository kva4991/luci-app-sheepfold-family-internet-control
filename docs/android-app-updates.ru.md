...
На телефоне оставлен `0.1.57`, чтобы владелец самостоятельно проверил системную установку.
...
Ожидаемый ручной результат: установленный `0.1.57` находит `0.1.58`, скачивает его,
Android предлагает обновление, а после подтверждения сохраняются привязка, язык, тема
и локальная защита. Этот последний этап остаётся непроверенным до ответа владельца.
