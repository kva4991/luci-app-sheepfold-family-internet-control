...
- Два пользовательских варианта Sheepfold не означают два репозитория: Standard и AI Support должны собираться из одного общего ядра, а Standard обязан физически не содержать AI/activity-модули (§prodvar).
