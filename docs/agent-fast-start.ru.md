...
1. Прочитать корневой `AGENTS.md` и этот файл.
...
4. Найти код и документацию задачи через `rg -n "ключевое слово|§тег"`, затем прочитать только найденные focused-документы и связанные вхождения §-тега.
