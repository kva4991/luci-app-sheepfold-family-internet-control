...
Локальное продолжение 09.09.2026: **r295**, база r294 `e1084e1`. Исправлены B50–B53:
ревизии admin-config при отказах, JSON-control, раскрытие файловых масок в списках и
рассогласование hardener с новой библиотекой pairing. [Реестр](bug-register.ru.md) —
53 карточки; профильные результаты и ограничения — в [отчёте r295](audit-fixes-r295.ru.md).
Следующий приоритет R03: согласованность остальных чтений модели и writers UCI;
текущая проверка ревизии не является неизменяемым снимком. D01 не изменён.
