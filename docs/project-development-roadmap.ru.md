...
Локальное продолжение 08.09.2026: r288 основан на r287 и объединённой истории четырёх
веток. Исправлены восемь дополнительных групп дефектов; полный локальный Node runner
прошёл 922 теста в 130 файлах. Подробный [реестр ошибок и причин решений](bug-register.ru.md)
отделяет прежние исправления от новых и от неподтверждённых аппаратных рисков.
