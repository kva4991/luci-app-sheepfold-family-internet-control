...
- главный координатор [`overview.js`](../package/luci-app-sheepfold-family-internet-control/htdocs/luci-static/resources/view/sheepfold/overview.js) всё ещё содержит около **5056 строк** при проектном предупреждающем пороге 700;
