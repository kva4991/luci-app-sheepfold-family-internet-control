...
Приложение показывает текущий статус интернета, точное время следующего изменения доступа и может уведомить незадолго до завершения временного разрешения.
