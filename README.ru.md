...
Проект развивается как приложение для OpenWRT-роутера с веб-интерфейсом LuCI, backend-сервисом, Android-приложением **Овчарня** и интеграцией с ботом в мессенджере для управления домашним интернетом.
